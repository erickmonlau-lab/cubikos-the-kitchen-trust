...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-B_iQKUHK.js
...
function Header() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: `fixed inset-x-0 top-0 z-50 transition-all duration-500 ${scrolled ? "bg-white/95 backdrop-blur-xl shadow-[0_4px_30px_rgba(0,0,0,0.08)] py-5" : "bg-transparent py-8"}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
						href: "#contacto",
						className: `flex items-center justify-center px-8 h-12 rounded-full font-bold text-[13px] uppercase tracking-[0.15em] transition-all duration-400 ${scrolled ? "bg-brand text-white hover:bg-ink hover:text-white shadow-[0_4px_15px_rgba(212,175,55,0.3)]" : "bg-brand text-white hover:scale-[1.02] shadow-[0_10px_30px_rgba(212,175,55,0.2)]"}`,
...
var AnimatedScrew = ({ className, delay }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
	initial: {
		scale: 0,
		opacity: 0
	},
...
var HammerHit = ({ className, delay }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
	initial: {
		opacity: 0,
		rotate: -45,
		x: -30,
...
function Hero() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		id: "top",
		className: "relative h-[100svh] min-h-[700px] flex flex-col justify-center overflow-hidden bg-ink",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(motion.div, {
			...
			className: "relative z-10 w-full h-full flex flex-col justify-center container-x",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "w-full max-w-[480px] pt-12 md:pt-0",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FadeUp, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							href: "#contacto",
							className: "group relative w-full sm:w-auto flex items-center justify-between gap-6 px-2 pl-8 h-16 rounded-full bg-brand text-white font-bold text-[14px] uppercase tracking-[0.15em] hover:scale-[1.02] transition-all duration-500 shadow-[0_10px_40px_rgba(212,175,55,0.3)] overflow-hidden",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "relative z-10",
								children: "Solicitar presupuesto"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "relative z-10 w-12 h-12 rounded-full bg-white flex items-center justify-center text-ink group-hover:rotate-45 transition-transform duration-500 shadow-sm",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
									width: "20",
									height: "20",
									viewBox: "0 0 24 24",
							...
							href: "#proyectos",
							className: "w-full sm:w-auto flex items-center justify-center px-10 h-16 rounded-full bg-black/40 backdrop-blur-md border border-white/40 text-white font-bold text-[14px] uppercase tracking-[0.15em] hover:bg-white hover:text-ink hover:scale-[1.02] transition-all duration-500 shadow-[0_10px_30px_rgba(0,0,0,0.3)]",
...
var PremiumFade = ({ children, delay = 0, className = "" }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
	initial: {
		opacity: 0,
		y: 40
	},
...
var PremiumScale = ({ children, delay = 0, className = "" }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
	initial: {
		opacity: 0,
		scale: .9
	},
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PremiumFade, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Mientras otras empresas reparten su atención entre reformas, coordinación de gremios y decenas de servicios distintos, Cubikos ha dedicado más de treinta años a una sola misión:" }),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Cada nivelación." }),
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											children: ["Solicitar Valoración", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Ico.Arrow, { className: "w-5 h-5 group-hover:translate-x-2 transition-transform duration-300" })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									className: "hover:text-brand transition-colors",
									children: ["+34 666 87 11 44 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
