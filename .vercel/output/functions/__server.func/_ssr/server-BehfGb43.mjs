...
import {
  ...
  w as executeRewriteInput,
  x as getStylesheetHref,
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-9iItt5FE.mjs");
