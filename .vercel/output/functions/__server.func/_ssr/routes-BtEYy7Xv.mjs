...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BtEYy7Xv.js
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						href: "#contacto",
						className: `group relative overflow-hidden flex items-center justify-center px-8 h-12 rounded-full font-bold text-[13px] uppercase tracking-[0.15em] transition-all duration-300 ${scrolled ? "bg-gradient-to-r from-[#FFDE00] to-[#F39C12] text-ink shadow-[0_5px_20px_rgba(243,156,18,0.4)] hover:shadow-[0_10px_30px_rgba(243,156,18,0.6)] hover:-translate-y-0.5" : "bg-white text-ink shadow-lg hover:shadow-2xl hover:-translate-y-0.5"}`,
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FadeUp, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
							...
							href: "#proyectos",
							className: "group relative overflow-hidden w-full sm:w-auto flex items-center justify-center px-10 h-16 rounded-full bg-white/5 backdrop-blur-md border border-white/30 text-white font-bold text-[14px] md:text-[15px] uppercase tracking-[0.2em] transition-all duration-300 shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:bg-white hover:text-ink hover:shadow-[0_15px_40px_rgba(255,255,255,0.2)] hover:-translate-y-1",
