import {
  A as invariant,
  D as rootRouteId,
  _ as TSR_SCRIPT_BARRIER_ID,
  g as GLOBAL_TSR,
  j as decodePath,
  k as createLRUCache,
  v as createInlineCssPlaceholderAsset,
  x as getStylesheetHref,
  y as createInlineCssStyleAsset,
...
function la(e, r) {
  ...
  if (t)
    for (let n = 0, a = t.length; n < a; n++) {
      let s = t[n];
      if (s.tag === r.c)
        return (e.child ?? (e.child = new Lr(e)), s.serialize(r.s, e.child, { id: r.i }));
    }
  throw new X(r.c);
}
function ca(e, r) {
