...
var timeoutManager = new ((_provider = /* @__PURE__ */ new WeakMap()),
...
var focusManager = new ((_focused = /* @__PURE__ */ new WeakMap()),
(_cleanup$1 = /* @__PURE__ */ new WeakMap()),
(_setup$1 = /* @__PURE__ */ new WeakMap()),
class extends Subscribable {
  constructor() {
    super();
  ...
  onSubscribe() {
    if (!_classPrivateFieldGet2(_cleanup$1, this))
      this.setEventListener(_classPrivateFieldGet2(_setup$1, this));
  }
  onUnsubscribe() {
  ...
  isFocused() {
    if (typeof _classPrivateFieldGet2(_focused, this) === "boolean")
      return _classPrivateFieldGet2(_focused, this);
...
var onlineManager = new ((_online = /* @__PURE__ */ new WeakMap()),
...
class extends Subscribable {
  ...
  onSubscribe() {
    if (!_classPrivateFieldGet2(_cleanup, this))
      this.setEventListener(_classPrivateFieldGet2(_setup, this));
  }
  onUnsubscribe() {
    if (!this.hasListeners()) {
...
var Query =
  ...
  (_retryer$1 = /* @__PURE__ */ new WeakMap()),
  (_defaultOptions$1 = /* @__PURE__ */ new WeakMap()),
  (_abortSignalConsumed = /* @__PURE__ */ new WeakMap()),
  (_Class_brand$1 = /* @__PURE__ */ new WeakSet()),
  class extends Removable {
    constructor(config) {
      super();
    ...
    optionalRemove() {
      if (!this.observers.length && this.state.fetchStatus === "idle")
        _classPrivateFieldGet2(_cache, this).remove(this);
    }
      ...
      if (this.observers.includes(observer)) {
        ...
        if (!this.observers.length) {
          if (_classPrivateFieldGet2(_retryer$1, this))
            if (
              _classPrivateFieldGet2(_abortSignalConsumed, this) ||
              _assertClassBrand(_Class_brand$1, this, _isInitialPausedFetch).call(this)
            )
              _classPrivateFieldGet2(_retryer$1, this).cancel({ revert: true });
    ...
    invalidate() {
      if (!this.state.isInvalidated)
        _assertClassBrand(_Class_brand$1, this, _dispatch$1).call(this, { type: "invalidate" });
    }
    async fetch(options, fetchOptions) {
      if (
        this.state.fetchStatus !== "idle" &&
        _classPrivateFieldGet2(_retryer$1, this)?.status() !== "rejected"
      ) {
      ...
      (_classPrivateFieldGet2(_queryType, this) === "infinite"
...
var Mutation =
  ...
  (_mutationCache$1 = /* @__PURE__ */ new WeakMap()),
  (_retryer = /* @__PURE__ */ new WeakMap()),
  (_Class_brand = /* @__PURE__ */ new WeakSet()),
  class extends Removable {
    constructor(config) {
      super();
    ...
    removeObserver(observer) {
      _classPrivateFieldSet2(
        _observers,
        this,
        _classPrivateFieldGet2(_observers, this).filter((x) => x !== observer),
      );
      this.scheduleGc();
      _classPrivateFieldGet2(_mutationCache$1, this).notify({
        type: "observerRemoved",
    ...
    continue() {
      return (
        _classPrivateFieldGet2(_retryer, this)?.continue() ?? this.execute(this.state.variables)
      );
    }
    async execute(variables) {
      ...
      try {
        if (restored) onContinue();
          ...
          if (_classPrivateFieldGet2(_mutationCache$1, this).config.onMutate)
            await _classPrivateFieldGet2(_mutationCache$1, this).config.onMutate(
              variables,
              this,
              mutationFnContext,
            );
        ...
        await _classPrivateFieldGet2(_mutationCache$1, this).config.onSuccess?.(
          data,
          variables,
          this.state.context,
          this,
        ...
        await _classPrivateFieldGet2(_mutationCache$1, this).config.onSettled?.(
          data,
          null,
        ...
        try {
          await _classPrivateFieldGet2(_mutationCache$1, this).config.onError?.(
            error,
            variables,
            this.state.context,
            this,
  ...
  class extends Subscribable {
    ...
    build(client, options, state) {
      ...
      const mutation = new Mutation({
        client,
        mutationCache: this,
        mutationId: _classPrivateFieldSet2(
          _mutationId,
          this,
          ((_this$mutationId = _classPrivateFieldGet2(_mutationId, this)), ++_this$mutationId),
        ),
        ...
        if (typeof scope === "string") {
          ...
          if (scopedMutations) {
            if (scopedMutations.length > 1) {
              ...
              _classPrivateFieldGet2(_scopes, this).delete(scope);
          }
        }
      }
      this.notify({
    ...
    canRun(mutation) {
      const scope = scopeFor(mutation);
      if (typeof scope === "string") {
        const firstPendingMutation = _classPrivateFieldGet2(_scopes, this)
          .get(scope)
    ...
    runNext(mutation) {
      ...
      if (typeof scope === "string")
        return (
          _classPrivateFieldGet2(_scopes, this)
            .get(scope)
  ...
  class {
    ...
    mount() {
      ...
      _classPrivateFieldSet2(
        _mountCount,
        this,
        ((_this$mountCount = _classPrivateFieldGet2(_mountCount, this)),
        _this$mountCount++,
        _this$mountCount),
      );
    ...
    unmount() {
      ...
      _classPrivateFieldSet2(
        _mountCount,
        this,
        ((_this$mountCount3 = _classPrivateFieldGet2(_mountCount, this)),
        _this$mountCount3--,
        _this$mountCount3),
      );
    ...
    setQueryData(queryKey, updater, options) {
      ...
      const prevData = _classPrivateFieldGet2(_queryCache, this).get(defaultedOptions.queryHash)
        ?.state.data;
    ...
    setQueriesData(filters, updater, options) {
      return notifyManager.batch(() =>
        _classPrivateFieldGet2(_queryCache, this)
          .findAll(filters)
    ...
    resumePausedMutations() {
      if (onlineManager.isOnline())
        return _classPrivateFieldGet2(_mutationCache, this).resumePausedMutations();
...
//#endregion
export {
  _classPrivateFieldInitSpec as a,
  _assertClassBrand as i,
  _classPrivateFieldGet2 as n,
  _classPrivateMethodInitSpec as o,
  _classPrivateFieldSet2 as r,
  QueryClient as t,
};
