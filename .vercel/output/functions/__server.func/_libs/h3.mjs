import {
  ...
  i as _assertClassBrand,
  n as _classPrivateFieldGet2,
  o as _classPrivateMethodInitSpec,
  r as _classPrivateFieldSet2,
} from "./@tanstack/query-core.mjs";
import "node:http";
...
var FastURL = /* @__PURE__ */ (() => {
  ...
  const FastURL =
    ...
    (_searchParams = /* @__PURE__ */ new WeakMap()),
    (_pos = /* @__PURE__ */ new WeakMap()),
    (_URL_brand = /* @__PURE__ */ new WeakSet()),
    ...
    class URL {
        ...
        if (typeof url === "string") {
          ...
          if (isOriginForm && !url.includes("#")) _classPrivateFieldSet2(_href, this, url);
            ...
            _classPrivateFieldSet2(
              _url,
              this,
              new NativeURL(isOriginForm ? `http://localhost${url}` : url),
            );
      ...
      get href() {
        ...
        if (!_classPrivateFieldGet2(_href, this))
          _classPrivateFieldSet2(
            _href,
            this,
            `${_classPrivateFieldGet2(_protocol, this) || "http:"}//${_classPrivateFieldGet2(_host, this) || "localhost"}${_classPrivateFieldGet2(_pathname, this) || "/"}${_classPrivateFieldGet2(_search, this) || ""}`,
          );
      ...
      get pathname() {
        ...
        if (_classPrivateFieldGet2(_pathname, this) === void 0) {
          const [, pathnameIndex, queryIndex] = _assertClassBrand(_URL_brand, this, _getPos).call(
            this,
          );
      ...
      get searchParams() {
        if (_classPrivateFieldGet2(_url, this))
          return _classPrivateFieldGet2(_url, this).searchParams;
        if (!_classPrivateFieldGet2(_searchParams, this))
          _classPrivateFieldSet2(_searchParams, this, new URLSearchParams(this.search));
  ...
  function _getPos() {
    if (!_classPrivateFieldGet2(_pos, this)) {
      ...
      _classPrivateFieldSet2(_pos, this, [protoIndex, pathnameIndex, qIndex]);
    }
...
var NodeResponse = /* @__PURE__ */ (() => {
  ...
  class NodeResponse {
    ...
    get status() {
      return (
        _classPrivateFieldGet2(_response, this)?.status ||
        _classPrivateFieldGet2(_init, this)?.status ||
        200
      );
    }
    get statusText() {
      return (
        _classPrivateFieldGet2(_response, this)?.statusText ||
        _classPrivateFieldGet2(_init, this)?.statusText ||
        STATUS_CODES[this.status] ||
        ""
      );
    }
    get headers() {
      if (_classPrivateFieldGet2(_response, this))
        return _classPrivateFieldGet2(_response, this).headers;
    ...
    get ok() {
      if (_classPrivateFieldGet2(_response, this))
        return _classPrivateFieldGet2(_response, this).ok;
    ...
    get _response() {
      ...
      _classPrivateFieldSet2(
        ...
        new NativeResponse(
          body,
          _classPrivateFieldGet2(_headers4, this)
            ? {
    ...
    _toNodeResponse() {
      ...
      let contentLength;
      if (_classPrivateFieldGet2(_response, this))
        body = _classPrivateFieldGet2(_response, this).body;
      else if (_classPrivateFieldGet2(_body, this))
        if (_classPrivateFieldGet2(_body, this) instanceof ReadableStream)
        ...
        } else if (typeof _classPrivateFieldGet2(_body, this).pipe === "function")
          body = _classPrivateFieldGet2(_body, this);
        else body = this._response.body;
      const headers = [];
      const initHeaders = _classPrivateFieldGet2(_init, this)?.headers;
      const headerEntries =
        _classPrivateFieldGet2(_response, this)?.headers ||
        _classPrivateFieldGet2(_headers4, this) ||
        (initHeaders
...
var H3Event =
  ...
  _defineProperty(_Class, "__is_event__", true),
  _Class);
...
var HTTPResponse =
  ...
  class {
    ...
    get headers() {
      return (
        _classPrivateFieldGet2(_headers, this) ||
        _classPrivateFieldSet2(
          _headers,
          this,
          new Headers(_classPrivateFieldGet2(_init2, this)?.headers),
        )
      );
    }
  });
...
var H3Core =
  ...
  _defineProperty(_Class2, "~h3", true),
  _Class2);
//#endregion
export {
  NodeResponse as a,
