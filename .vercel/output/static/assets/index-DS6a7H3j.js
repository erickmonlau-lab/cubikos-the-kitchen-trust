var e = Object.create,
  ...
  v = s((e) => {
    ...
    function Se(e) {
      (ge.current === e && (O(he), O(ge)), ve.current === e && (O(ve), ($f._currentValue = fe)));
    }
    var Ce, we;
    function Te(e) {
      if (Ce === void 0)
...
` +
    ...
    function Ha(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === y
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === ie && Pa(i) === t.type))
                ...
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === y)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === ie && Pa(l) === r.type)
                    ) {
    ...
    function fo(e) {
      (k(go, go.current), k(co, e), lo === null && (lo = e));
    }
    function po(e) {
      e.tag === 22 ? (k(go, go.current), k(co, e), lo === null && (lo = e)) : mo(e);
    }
    function mo() {
      (k(go, go.current), k(co, co.current));
    }
    function ho(e) {
      (O(co), lo === e && (lo = null), O(go));
    }
    var go = D(0);
    function _o(e) {
      for (var t = e; t !== null; ) {
    ...
    function Oo(e) {
      ...
      e === null || cc || ((e = e.dependencies), e !== null && aa(e) && (cc = !0));
    }
    function ko(e, t, n, r) {
      L = e;
      var a = 0;
    ...
    function Ho(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !kr(o, e.memoizedState) && ((cc = !0), d && ((n = ya), n !== null)))
        )
          throw n;
    ...
    function ss(e, t, n) {
      ...
      return (
        n !== t.memoizedState &&
          ((L.flags |= 2048), us(9, { destroy: void 0 }, cs.bind(null, i, n), null)),
        [r, a, e]
      );
    }
    function cs(e, t) {
    ...
    function Ds(e, t, n, r, i) {
      ...
      try {
        ...
        Rs(e, t, { then: function () {}, status: `rejected`, reason: n }, mu());
      } finally {
    ...
    function js(e) {
      var t = As(e);
      (t.next === null && (t = e.alternate.memoizedState), Rs(e, t.next.queue, {}, mu()));
    }
    function Ms() {
      return sa($f);
    }
    ...
    function Is(e, t, n) {
      ...
      ((n = {
        ...
        Bs(e) ? Vs(t, n) : ((n = li(e, t, n, r)), n !== null && (gu(n, e, r), Hs(n, t, r))));
    }
    function Ls(e, t, n) {
      Rs(e, t, n, mu());
    }
    function Rs(e, t, n, r) {
      ...
      if (Bs(e)) Vs(t, i);
        ...
        if (((n = li(e, t, i, r)), n !== null)) return (gu(n, e, r), Hs(n, t, r), !0);
      }
      return !1;
    }
    function zs(e, t, n, r) {
    ...
    var Ws = {
        ...
        useTransition: function () {
          var e = Xo(!1);
          return ((e = Ds.bind(null, L, e.queue, !0, !1)), (Po().memoizedState = e), [!1, e]);
        },
        ...
        useOptimistic: function (e) {
          ...
          return ((t.queue = n), (t = zs.bind(null, L, !0, n)), (n.dispatch = t), [e, t]);
        },
        useMemoCache: zo,
    ...
    function oc(e, t, n, r, a) {
      ...
      if (((o = Ti(o, n)), Zl === null ? (Zl = [o]) : Zl.push(o), Gl !== 4 && (Gl = 2), t === null))
        return !0;
      ((r = Ti(r, n)), (n = t));
      do {
        switch (n.tag) {
    ...
    function uc(e, t, n, r, i) {
      ...
      return (
        ...
        e !== null && !cc
          ? (Mo(e, t, i), Mc(e, t, i))
          : (P && s && Li(t), (t.flags |= 1), lc(e, t, r, i), t.child)
      );
    }
    ...
    function fc(e, t, n, r, i) {
      if (e !== null) {
        ...
        if (Ar(a, r) && e.ref === t.ref)
          if (((cc = !1), (t.pendingProps = r = a), H(e, i))) e.flags & 131072 && (cc = !0);
    ...
    function B(e, t, n) {
      ...
      if (o !== null) {
        ...
        else if ((cc || ia(e, t, n, !1), (a = (n & e.childLanes) !== 0), cc || a)) {
          if (((r = q), r !== null && ((s = ut(r, n)), s !== 0 && s !== o.retryLane)))
            throw ((o.retryLane = s), ui(e, s), gu(r, e, s), sc);
          (Ou(), (t = _c(e, t, n)));
        } else
          ((e = o.treeContext),
            (N = lf(s.nextSibling)),
    ...
    function vc(e, t, n, r, i) {
      return (
        ...
        e !== null && !cc
          ? (Mo(e, t, i), Mc(e, t, i))
          : (P && r && Li(t), (t.flags |= 1), lc(e, t, n, i), t.child)
      );
    }
    function yc(e, t, n, r, i, a) {
      return (
        ...
        e !== null && !cc
          ? (Mo(e, t, a), Mc(e, t, a))
          : (P && r && Li(t), (t.flags |= 1), lc(e, t, n, a), t.child)
      );
    }
    ...
    function xc(e, t, n, r) {
      return (Ji(), (t.flags |= 256), lc(e, t, n, r), t.child);
    }
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          ((s = u),
            ...
            (t = Oc(e, t, n)));
        } else if ((cc || ia(e, t, n, !1), (s = (n & e.childLanes) !== 0), cc || s)) {
          if (((s = q), s !== null && ((r = ut(s, n)), r !== 0 && r !== l.retryLane)))
            throw ((l.retryLane = r), ui(e, r), gu(s, e, r), sc);
          (of(c) || Ou(), (t = Oc(e, t, n)));
        } else
          of(c)
    ...
    function Pc(e, t, n) {
      if (e !== null)
        if (e.memoizedProps !== t.pendingProps) cc = !0;
          ...
          if (!H(e, n) && !(t.flags & 128)) return ((cc = !1), Nc(e, t, n));
          cc = !!(e.flags & 131072);
        }
      else ((cc = !1), P && t.flags & 1048576 && Ii(t, ki, t.index));
      switch (((t.lanes = 0), t.tag)) {
        case 16:
          a: {
            ...
            if (((e = Pa(t.elementType)), (t.type = e), typeof e == `function`))
              gi(e)
                ? ((r = Zs(e, r)), (t.tag = 1), (t = bc(null, t, e, r, n)))
        ...
        case 1:
          return ((r = t.type), (a = Zs(r, t.pendingProps)), bc(e, t, r, a, n));
        case 3:
          a: {
          ...
          return (
            e === null &&
              ...
              ((a = r = N) &&
                ...
                r === null
                  ? (a = !1)
                  : ((t.stateNode = r), (Bi = t), (N = lf(r.firstChild)), (Hi = !1), (a = !0))),
              a || Wi(t)),
            xe(t),
            (a = t.type),
            (o = t.pendingProps),
        ...
        case 4:
          return (
            ye(t, t.stateNode.containerInfo),
            (r = t.pendingProps),
            e === null ? (t.child = Ua(t, null, r, n)) : lc(e, t, r, n),
            t.child
          );
        case 11:
        ...
        case 12:
          return (lc(e, t, t.pendingProps.children, n), t.child);
        case 10:
          return ((r = t.pendingProps), ea(t, t.type, r.value), lc(e, t, r.children, n), t.child);
        case 9:
          return (
            (a = t.type._context),
      ...
      switch ((Ri(t), t.tag)) {
        ...
        case 27:
          if ((Se(t), (n = _e.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = he.current), qi(t) ? Gi(t, e) : ((e = pf(a, r, n)), (t.stateNode = e), Fc(t)));
          }
          return (U(t), null);
        case 5:
          ...
          if (e && t.stateNode != null) e.memoizedProps !== r && Fc(t);
            ...
            if (((e = _e.current), qi(t))) {
              ...
              ((e[A] = t),
                ...
                e || Wi(t, !0));
            } else ((e = Vd(e).createTextNode(r)), (e[A] = t), (t.stateNode = e));
          }
          return (U(t), null);
        case 31:
        ...
        case 19:
          if ((O(go), (r = t.memoizedState), r === null)) return (U(t), null);
                ...
                for (e = t.child; e !== null; ) {
                  if (((o = _o(e)), o !== null)) {
                    for (
                      ...
                      (vi(n, e), (n = n.sibling));
                    return (k(go, (go.current & 1) | 2), P && Fi(t, r.treeForkCount), t.child);
                  }
                  e = e.sibling;
                }
              r.tail !== null &&
    ...
    function vl(e, t) {
      ...
      switch (e.tag) {
        ...
        case 26:
          var a = _l;
          if ((gl(t, e), yl(e), r & 512 && (nl || n === null || Jc(n, n.return)), r & 4)) {
        ...
        case 27:
          ...
          break;
        case 5:
          if ((gl(t, e), yl(e), r & 512 && (nl || n === null || Jc(n, n.return)), e.flags & 32)) {
            a = e.stateNode;
            try {
              en(a, ``);
            } catch (t) {
    ...
    var Rl = {
      ...
      pu = null;
    function mu() {
      return K & 2 && Y !== 0 ? Y & -Y : w.T === null ? pt() : fd();
    }
    function hu() {
      if (Yl === 0)
        if (!(Y & 536870912) || P) {
    ...
    function wu(e, t) {
      ((L = null),
        ...
        t === Oa || t === Aa
          ...
          : t === ka
            ? ((t = Fa()), (X = 4))
            : (X = t === sc ? 8 : typeof t == `object` && t && typeof t.then == `function` ? 6 : 1),
        (Bl = t),
        J === null && ((Gl = 1), tc(e, Ti(t, e.current))));
    }
    function Tu() {
      var e = co.current;
      return e === null
    ...
    function ju(e, t) {
      ...
      var r = Eu(),
        a = Du();
      q !== e || Y !== t ? ((ru = null), (nu = Fe() + 500), Cu(e, t)) : (Hl = nt(e, t));
      a: do
        try {
          if (X !== 0 && J !== null) {
            t = J;
    ...
    function Pu(e) {
      ...
      switch (t.tag) {
        ...
        case 5:
          No(t);
        default:
          (Hc(n, t), (t = J = vi(t, Wl)), (t = Pc(n, t, Wl)));
      }
      ((e.memoizedProps = e.pendingProps), t === null ? Iu(e) : (J = t));
    }
    function Fu(e, t, n, r) {
      ...
      try {
        if (oc(e, i, t, n, Y)) {
          ((Gl = 1), tc(e, Ti(n, e.current)), (J = null));
          return;
        }
      } catch (t) {
    ...
    function qu(e, t, n) {
      ...
      (r !== null && r.delete(t),
        ...
        q === e &&
          (Y & n) === n &&
          (Gl === 4 || (Gl === 3 && (Y & 62914560) === Y && 300 > Fe() - eu)
            ? !(K & 2) && Cu(e, 0)
            : (Jl |= n),
          Xl === Y && (Xl = 0)),
        id(e));
    ...
    function hd(e, t, n, r, i) {
      if (t === `submit` && n && n.stateNode === i) {
        var a = pd((i[gt] || null).action),
          o = r.submitter;
        o &&
          ((t = (t = o[gt] || null) ? pd(t.formAction) : o.getAttribute(`formAction`)),
          t !== null && ((a = t), (o = null)));
...
`,
        ...
        ((i = `link[rel="` + e + `"][href="` + i + `"]`),
          ...
          gf.has(i) ||
            ...
            r.querySelector(i) === null &&
              ((t = r.createElement(`link`)), Fd(t, `link`, e), Ot(t), r.head.appendChild(t))));
      }
    }
    function Cf(e) {
    ...
    function Ef(e, t) {
      ...
      if (n && e) {
        ...
        if (
          !hf.has(a) &&
          ((e = f({ rel: `modulepreload`, href: e }, t)), hf.set(a, e), n.querySelector(i) === null)
        ) {
          switch (r) {
            case `audioworklet`:
            case `paintworklet`:
...
function le(e) {
  for (let t in e) if (se.call(e, t)) return !0;
  return !1;
}
...
function E(e) {
  ...
  for (let n of t) if (!ce.call(e, n)) return !1;
...
function at({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  ...
  if (a) s = e.split(`/`);
    ...
    for (s = e.split(`/`); s.length > 1 && ie(s) === ``; ) s.pop();
    let n = t.split(`/`);
  ...
  s.length > 1 && (ie(s) === `` ? n === `never` && s.pop() : n === `always` && s.push(``));
  let c = $e(s.join(`/`)) || `/`;
          ...
          if (e) {
            ...
            for (let n in e) {
              if (n === At) {
                ...
                let e = jt(n);
                if (!e || (s && o && ((c ??= Mt(o)), c.includes(e)))) continue;
              }
              ((t ||= Tt[l] = {}), (t[n] ??= e[n]));
            }
          }
...
var Rt = (e) => {
  ...
  Kt = (e, t, n) => {
    ...
    (e.updateMatch(
      ...
      !e.preload && !A(n) && !ut(n) && (e.serialError ??= n));
  },
  qt = (e, t, n, r) => {
...
var Sn = new WeakMap(),
  Cn = class {
        ...
        (this.buildLocation = (e) => {
          let t = (t = {}) => {
              ...
              let h = this.options.stringifySearch(m),
                g = t.hash === !0 ? n.hash : t.hash ? oe(t.hash, n.hash) : void 0,
                _ = g ? `#${g}` : ``,
                v = t.state === !0 ? n.state : t.state ? oe(t.state, n.state) : {};
              v = w(n.state, v);
              let y = `${p}${h}${_}`,
                b,
                x,
    ...
    matchRoutesInternal(e, t) {
      ...
      for (let n = 0; n < a.length; n++) {
        ...
        if (v)
          S = {
            ...
            params: y?.params ?? i,
            _strictParams: b,
            search: de(y ? y.search : v.search, u),
            _strictSearch: d,
          };
        else {
          let e =
          ...
          S = {
            ...
            fetchCount: 0,
            cause: ee,
            loaderDeps: y ? w(y.loaderDeps, p) : p,
            invalid: !1,
            preload: !1,
            links: void 0,
            scripts: void 0,
      ...
      for (let t = 0; t < c.length; t++) {
        let n = c[t],
          ...
          o = l.get(n.routeId);
        if (((n.params = o ? de(o.params, i) : i), !a)) {
          let i = c[t - 1],
    ...
    matchRoutesLightweight(e) {
      ...
      let a = ie(this.stores.matchesId.get()),
...
function io(e, t, n) {
  ...
  if (r) {
    ...
    for (let a = 0, o = r.length; a < o; a++) {
      let o = r[a];
      if (o.tag === i) return F(e, n.i, o.deserialize(n.s, new ja(e, t), { id: n.i }));
    }
  }
  throw new pi(n.c);
}
...
async function ts(e, t, n) {
  ...
  if (
    ...
    a === `payload` && o.set(`accept`, `${ee}, application/x-ndjson, application/json`),
    r.method === `GET`)
  ) {
...
var fs = (e, t) => {
  let n = { type: `request`, ...(t || e) },
    r = (e) => fs({}, Object.assign(n, { validator: e, inputValidator: e }));
  return {
    options: n,
    middleware: (e) => fs({}, Object.assign(n, { middleware: e })),
    validator: r,
    inputValidator: r,
    client: (e) => fs({}, Object.assign(n, { client: e })),
    server: (e) => fs({}, Object.assign(n, { server: e })),
  };
};
function ps(e, t) {
  for (let n = 0, r = t.length; n < r; n++) {
    let r = t[n];
    e.has(r) || (e.add(r), r.extends && ps(e, r.extends));
  }
}
var ms = (e) => ({
    getOptions: async () => {
      ...
      if (t.serializationAdapters) {
        let e = new Set();
        (ps(e, t.serializationAdapters), (t.serializationAdapters = Array.from(e)));
      }
      return t;
    },
    createMiddleware: fs,
...
function Ds(e, t) {
  ...
  if (o) {
    if (r) {
      if (t.queryHash !== ks(o, t.options)) return !1;
...
function Os(e, t) {
  ...
  if (a) {
    ...
    if (n) {
      if (As(t.options.mutationKey) !== As(a)) return !1;
    } else if (!js(t.options.mutationKey, a)) return !1;
  }
  return !((r && t.state.status !== r) || (i && !i(t)));
}
function ks(e, t) {
  return (t?.queryKeyHashFn || As)(e);
}
function As(e) {
...
function js(e, t) {
  return e === t
    ...
    : typeof e == typeof t && e && t && typeof e == `object` && typeof t == `object`
      ? Object.keys(t).every((n) => js(e[n], t[n]))
      : !1;
}
...
function $s(e) {
  return (e ?? `online`) === `online` ? Ys.isOnline() : !0;
}
...
function tc(e) {
  let t = !1,
    ...
    l = () => Js.isFocused() && (e.networkMode === `always` || Ys.isOnline()) && e.canRun(),
...
var nc = class {
  ...
  updateGcTime(e) {
    this.gcTime = Math.max(this.gcTime || 0, e ?? (Zs.isServer() ? 1 / 0 : 300 * 1e3));
  }
  clearGcTimeout() {
    this.#e !== void 0 && (vs.clearTimeout(this.#e), (this.#e = void 0));
  }
};
function rc(e) {
  return {
      ...
      let r = t.options,
        ...
        l = async () => {
          ...
          if (i && a.length) {
            ...
            let t = e ?? a.length;
            do {
              let e = c === 0 ? (o[0] ?? r.initialPageParam) : ic(r, s);
              if (c > 0 && e == null) break;
              ((s = await d(s, e)), c++);
            } while (c < t);
          }
...
var oc = class extends nc {
  ...
  setOptions(e) {
    if (
      ...
      e.data !== void 0 && (this.setState(cc(e.data, e.dataUpdatedAt)), (this.#t = e));
    }
  }
  optionalRemove() {
  ...
  setData(e, t) {
    let n = Rs(this.state.data, e, this.options);
    return (
  ...
  cancel(e) {
    ...
    return (this.#a?.cancel(e), t ? t.then(xs).catch(xs) : Promise.resolve());
  }
  destroy() {
  ...
  isActive() {
    return this.observers.some((e) => Es(e.options.enabled, this) !== !1);
  }
  isDisabled() {
    return this.getObserversCount() > 0
      ? !this.isActive()
      : this.options.queryFn === Vs || !this.isFetched();
  }
  isFetched() {
  ...
  isStatic() {
    return this.getObserversCount() > 0
      ? this.observers.some((e) => Ts(e.options.staleTime, this) === `static`)
      : !1;
  }
  isStale() {
    return this.getObserversCount() > 0
  ...
  async fetch(e, t) {
    ...
    ((this.#e === `infinite` ? rc(this.options.pages) : this.options.behavior)?.onFetch(a, this),
      (this.#n = this.state),
      ...
      (this.#a = tc({
        ...
        fn: a.fetchFn,
        onCancel: (e) => {
          (e instanceof ec && e.revert && this.setState({ ...this.#n, fetchStatus: `idle` }),
            n.abort());
        },
        onFail: (e, t) => {
  ...
  #l(e) {
    let t = (t) => {
      switch (e.type) {
        ...
        case `fetch`:
          return { ...t, ...sc(t.data, this.options), fetchMeta: e.meta ?? null };
        case `success`:
          let n = {
            ...t,
            ...cc(e.data, e.dataUpdatedAt),
...
var uc = class extends qs {
    ...
    find(e) {
      let t = { exact: !0, ...e };
      return this.getAll().find((e) => Ds(t, e));
    }
    findAll(e = {}) {
      let t = this.getAll();
      return Object.keys(e).length > 0 ? t.filter((t) => Ds(e, t)) : t;
    }
    notify(e) {
      Ks.batch(() => {
        this.listeners.forEach((t) => {
...
var pc = class extends qs {
  ...
  find(e) {
    let t = { exact: !0, ...e };
    return this.getAll().find((e) => Os(t, e));
  }
  findAll(e = {}) {
    return this.getAll().filter((t) => Os(e, t));
  }
  notify(e) {
    Ks.batch(() => {
      this.listeners.forEach((t) => {
  ...
  resumePausedMutations() {
    ...
    return Ks.batch(() => Promise.all(e.map((e) => e.continue().catch(xs))));
  }
};
function mc(e) {
...
var hc = class {
    ...
    #s;
    constructor(e = {}) {
      ((this.#e = e.queryCache || new uc()),
        (this.#t = e.mutationCache || new pc()),
    ...
    mount() {
      (this.#a++,
        this.#a === 1 &&
          ((this.#o = Js.subscribe(async (e) => {
            e && (await this.resumePausedMutations(), this.#e.onFocus());
          })),
          (this.#s = Ys.subscribe(async (e) => {
    ...
    ensureQueryData(e) {
      ...
      return r === void 0
        ? this.fetchQuery(e)
        : (e.revalidateIfStale && n.isStaleByTime(Ts(t.staleTime, n)) && this.prefetchQuery(t),
          Promise.resolve(r));
    }
    getQueriesData(e) {
    ...
    cancelQueries(e, t = {}) {
      let n = { revert: !0, ...t },
        r = Ks.batch(() => this.#e.findAll(e).map((e) => e.cancel(n)));
      return Promise.all(r).then(xs).catch(xs);
    }
        ...
        r = Ks.batch(() =>
          this.#e
            ...
            .map((e) => {
              ...
              return (
                n.throwOnError || (t = t.catch(xs)),
                e.state.fetchStatus === `paused` ? Promise.resolve() : t
              );
            }),
        );
      return Promise.all(r).then(xs);
    }
    fetchQuery(e) {
      let t = this.defaultQueryOptions(e);
      t.retry === void 0 && (t.retry = !1);
      let n = this.#e.build(this, t);
      return n.isStaleByTime(Ts(t.staleTime, n)) ? n.fetch(t) : Promise.resolve(n.state.data);
    }
    prefetchQuery(e) {
      return this.fetchQuery(e).then(xs).catch(xs);
    }
    fetchInfiniteQuery(e) {
      return ((e._type = `infinite`), this.fetchQuery(e));
    }
    prefetchInfiniteQuery(e) {
      return this.fetchInfiniteQuery(e).then(xs).catch(xs);
    }
    ensureInfiniteQueryData(e) {
      return ((e._type = `infinite`), this.ensureQueryData(e));
    }
    resumePausedMutations() {
      return Ys.isOnline() ? this.#t.resumePausedMutations() : Promise.resolve();
    }
    getQueryCache() {
      return this.#e;
    }
    ...
    setQueryDefaults(e, t) {
      this.#r.set(As(e), { queryKey: e, defaultOptions: t });
    }
    getQueryDefaults(e) {
      let t = [...this.#r.values()],
        n = {};
      return (
        t.forEach((t) => {
          js(e, t.queryKey) && Object.assign(n, t.defaultOptions);
        }),
        n
      );
    }
    setMutationDefaults(e, t) {
      this.#i.set(As(e), { mutationKey: e, defaultOptions: t });
    }
    getMutationDefaults(e) {
      ...
      return (
        t.forEach((t) => {
          js(e, t.mutationKey) && Object.assign(n, t.defaultOptions);
        }),
        n
      );
    }
    defaultQueryOptions(e) {
      ...
      return (
        (t.queryHash ||= ks(t.queryKey, t)),
        t.refetchOnReconnect === void 0 && (t.refetchOnReconnect = t.networkMode !== `always`),
        t.throwOnError === void 0 && (t.throwOnError = !!t.suspense),
        !t.networkMode && t.persister && (t.networkMode = `offlineFirst`),
        t.queryFn === Vs && (t.enabled = !1),
        t
      );
    }
  ...
  B = u(p(), 1),
  V = _c(),
  vc = B.createContext(void 0),
  yc = ({ client: e, children: t }) => (
    B.useEffect(
      () => (
        e.mount(),
        () => {
    ...
    (0, V.jsx)(vc.Provider, { value: e, children: t })
  ),
  bc = B.use,
  xc = typeof window < `u` ? B.useLayoutEffect : B.useEffect;
function Sc(e) {
...
function kc(e) {
  return B.useContext(Oc);
}
function Ac({ children: e, fallback: t = null }) {
  return jc() ? (0, V.jsx)(B.Fragment, { children: e }) : (0, V.jsx)(B.Fragment, { children: t });
}
function jc() {
...
function Nc({ update: e, notify: t, unwatched: n }) {
...
var Fc = [],
  Ic = 0,
  {
    ...
    notify(e) {
      ((Fc[Hc++] = e), (e.flags &= ~H.Watching));
    },
    unwatched(e) {
      e.depsTail !== void 0 && ((e.depsTail = void 0), (e.flags = H.Mutable | H.Dirty), Kc(e));
    },
  }),
  Vc = 0,
  Hc = 0,
...
function Kc(e) {
  ...
  for (; n !== void 0; ) n = Rc(n, e);
}
function qc() {
  if (!(Wc > 0)) {
    for (; Vc < Hc; ) {
      let e = Fc[Vc];
      ((Fc[Vc++] = void 0), e.notify());
    }
    ((Vc = 0), (Hc = 0));
  }
}
function Jc(e, t) {
  let n = typeof e == `function`,
    ...
    i = {
      ...
      get() {
        return (Uc !== void 0 && Lc(i, Uc, Ic), i._snapshot);
      },
      subscribe(e) {
        let t = Pc(e),
          n = { current: !1 },
      ...
      _update(e) {
        ...
        if (n) ((Uc = i), ++Ic, (i.depsTail = void 0));
        ...
        try {
          ...
          ((Uc = a), n && (i.flags &= ~H.RecursedCheck), Kc(i));
        }
      },
    };
  return (
    n
      ? ((i.flags = H.Mutable | H.Dirty),
        (i.get = function () {
          let e = i.flags;
          if (e & H.Dirty || (e & H.Pending && U(i.deps, i))) {
            if (i._update()) {
              let e = i.subs;
              e !== void 0 && Bc(e);
            }
...
function Yc(e) {
  let t = () => {
      let t = Uc;
      ((Uc = n), ++Ic, (n.depsTail = void 0), (n.flags = H.Watching | H.RecursedCheck));
      try {
        return e();
      } finally {
        ((Uc = t), (n.flags &= ~H.RecursedCheck), Kc(n));
      }
    },
    n = {
      deps: void 0,
      ...
      notify() {
        let e = this.flags;
        e & H.Dirty || (e & H.Pending && U(this.deps, this)) ? t() : (this.flags = H.Watching);
      },
      stop() {
        ((this.flags = H.None), (this.depsTail = void 0), Kc(this));
      },
    };
  return (t(), n);
}
...
function W(e, t, n = el) {
  ...
  return (0, $c.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
var tl = _();
function nl(e, t) {
  let n = kc(),
    ...
    _e = B.useMemo(() => ul(he, ge, n.history, v), [v, ge, he, n.history]),
    ve = B.useMemo(() => {
      if (_e?.external) return ye(_e.href, n.protocolAllowlist) ? void 0 : _e.href;
      if (!dl(s) && !(typeof s != `string` || s.indexOf(`:`) === -1))
        try {
    ...
    be = B.useMemo(() => {
      ...
      return (o?.includeSearch ?? !0) &&
        !D(O.search, k.search, { partial: !o?.exact, ignoreUndefined: !o?.explicitUndefined })
        ? !1
        : o?.includeHash
          ? pe && O.hash === k.hash
          : !0;
  ...
  let je = (e) => {
    let t = e.currentTarget.getAttribute(`target`),
      r = _ === void 0 ? t : _;
    if (!v && !pl(e) && !e.defaultPrevented && (!r || r === `_self`) && e.button === 0) {
      (e.preventDefault(),
        (0, tl.flushSync)(() => {
          Ee(!0);
        }));
  ...
  return {
    ...
    onBlur: ll([ee, Pe]),
    onFocus: ll([S, Me]),
    onMouseEnter: ll([C, Me]),
    onMouseLeave: ll([te, Pe]),
    onTouchStart: ll([ne, Ne]),
    disabled: !!v,
    target: _,
    ...(we && { style: we }),
    ...(Ce && { className: Ce }),
...
var rl = {},
  il = { className: `active` },
  al = { role: `link`, "aria-disabled": !0 },
  ol = { "data-status": `active`, "aria-current": `page` },
  sl = { "data-transitioning": `transitioning` },
  cl = new WeakMap(),
  G = { rootMargin: `100px` },
  ll = (e) => (t) => {
    for (let n of e)
...
function _l(e, t) {
  ...
  return (r) => {
    ...
    return (e?.structuralSharing ?? t.options.defaultStructuralSharing)
      ? (n.current = w(n.current, i))
      : i;
  };
}
function vl(e) {
  let t = kc(),
    n = B.useContext(e.from ? hl : ml),
...
function bl(e) {
  let { select: t, ...n } = e;
  return vl({ ...n, select: (e) => (t ? t(e.loaderDeps) : e.loaderDeps) });
}
function xl(e) {
  return vl({
    from: e.from,
...
function wl(e) {
  return vl({ ...e, select: (t) => (e.select ? e.select(t.context) : t.context) });
}
var Tl = class extends Hn {
  constructor(e) {
    (super(e),
      (this.useMatch = (e) =>
        vl({ select: e?.select, from: this.id, structuralSharing: e?.structuralSharing })),
      (this.useRouteContext = (e) => wl({ ...e, from: this.id })),
      (this.useSearch = (e) =>
        Sl({ select: e?.select, structuralSharing: e?.structuralSharing, from: this.id })),
      (this.useParams = (e) =>
        xl({ select: e?.select, structuralSharing: e?.structuralSharing, from: this.id })),
      (this.useLoaderDeps = (e) => bl({ ...e, from: this.id })),
      (this.useLoaderData = (e) => yl({ ...e, from: this.id })),
      (this.useNavigate = () => Cl({ from: this.fullPath })),
      (this.Link = B.forwardRef((e, t) => (0, V.jsx)(fl, { ref: t, from: this.fullPath, ...e }))));
  }
};
function El(e) {
  return new Tl(e);
...
function Al(e) {
  return new jl(e, { silent: !0 }).createRoute;
}
var jl = class {
  constructor(e, t) {
    ((this.path = e),
...
var Pl = class extends B.Component {
  constructor(...e) {
...
var K = (e, t) => e.routeId === t.routeId && e._displayPending === t._displayPending,
  q = (e, t) => e[0] === t[0] && e[1] === t[1],
  J = B.memo(function ({ matchId: e }) {
    let t = kc(),
...
function Y({ router: e, matchId: t, resetKey: n, matchState: r }) {
  let i = e.routesById[r.routeId],
    ...
    f = s ? Nl : Rl,
    p = l ? Il : Rl;
  return (0, V.jsxs)(i.isRoot ? (i.options.shellComponent ?? Rl) : Rl, {
    children: [
      (0, V.jsx)(ml.Provider, {
        value: t,
        children: (0, V.jsx)(d, {
          ...
          children: (0, V.jsx)(f, {
            ...
            children: (0, V.jsx)(p, {
              ...
              children:
                u || r._displayPending
                  ? (0, V.jsx)(Ac, { fallback: o, children: (0, V.jsx)(Bl, { matchId: t }) })
                  : (0, V.jsx)(Bl, { matchId: t }),
            }),
          }),
        }),
      }),
      r.parentRouteId === `__root__`
        ? (0, V.jsxs)(V.Fragment, {
            children: [(0, V.jsx)(X, {}), (e.options.scrollRestoration, null)],
          })
        : null,
    ],
  });
...
var Bl = B.memo(function ({ matchId: e }) {
    let t = kc(),
    ...
    let i = W(r, (e) => e),
      ...
      c = B.useMemo(() => {
        ...
        return e ? (0, V.jsx)(e, {}, s) : (0, V.jsx)(Vl, {});
    ...
    if (i.status === `notFound`) return (ut(i.error) || Ee(), zl(t, o, i.error));
  ...
  Vl = B.memo(function () {
      ...
      i;
    {
      ...
      (([n, r] = W(a, (e) => [e?.routeId, e?.globalNotFound ?? !1], q)),
    ...
    let a = n ? e.routesById[n] : void 0,
      o = e.options.defaultPendingComponent
        ...
        : null;
    if (r) return (a || Ee(), zl(e, a, void 0));
    if (!i) return null;
    let s = (0, V.jsx)(J, { matchId: i });
    return n === `__root__` ? (0, V.jsx)(B.Suspense, { fallback: o, children: s }) : s;
  }),
  Hl = (e) => ({ createMutableStore: Jc, createReadonlyStore: Jc, batch: Gc }),
  Ul = (e) => new Wl(e),
  Wl = class extends Cn {
    constructor(e) {
      super(e, Hl);
...
function Kl() {
  let e = kc(),
    ...
    n = t ? (0, V.jsx)(t, {}) : null,
    r = (0, V.jsxs)(typeof document < `u` && e.ssr ? Rl : B.Suspense, {
      fallback: n,
      children: [(0, V.jsx)(Gl, {}), (0, V.jsx)(ql, {})],
    });
...
function ql() {
  let e = kc(),
    ...
    r = t ? (0, V.jsx)(J, { matchId: t }) : null;
  return (0, V.jsx)(ml.Provider, {
    value: t,
    children: e.options.disableGlobalCatchBoundary
      ? r
      : (0, V.jsx)(Nl, { getResetKey: () => n, errorComponent: Fl, onCatch: void 0, children: r }),
  });
}
function Jl({ router: e, children: t, ...n }) {
  le(n) && e.update({ ...e.options, ...n, context: { ...e.options.context, ...n.context } });
  let r = (0, V.jsx)(Oc.Provider, { value: e, children: t });
  return e.options.Wrap ? (0, V.jsx)(e.options.Wrap, { children: r }) : r;
}
function Yl({ router: e, ...t }) {
  return (0, V.jsx)(Jl, { router: e, ...t, children: (0, V.jsx)(Kl, {}) });
}
function Xl(e, t) {
  if (t)
...
function Zl(e) {
  ...
  switch (e.tag) {
    ...
    case `script`:
      return (0, V.jsx)(Ql, { attrs: t, preventScriptHoist: i, children: n });
    default:
      return null;
  }
}
function Ql({ attrs: e, children: t, preventScriptHoist: n }) {
  kc();
  let r = jc(),
    i =
    ...
    (B.useEffect(() => {
      if (!i) {
        if (e?.src) {
          ...
          return (Xl(n, e), document.head.appendChild(n), () => n.remove());
        }
        if (typeof t == `string`) {
          ...
          return ((i.textContent = t), Xl(i, e), document.head.appendChild(i), () => i.remove());
        }
      }
    }, [e, t, i]),
    i && typeof t == `string`)
...
var $l = (e) => {
  let t = kc(),
    ...
    r = W(t.stores.matches, (e) => e.map((e) => e.meta).filter((e) => e !== void 0), D),
    i = B.useMemo(() => {
      let e = [],
        t = {},
        i;
...
function eu(e) {
  let t = $l(e.assetCrossOrigin),
    n = kc().options.ssr?.nonce;
  return (0, V.jsx)(V.Fragment, {
    children: t.map((e) =>
      (0, B.createElement)(Zl, { ...e, key: `tsr-meta-${JSON.stringify(e)}`, nonce: n }),
    ),
  });
}
var tu = () => {
  ...
  return (0, V.jsxs)(`html`, {
    ...
    children: [
      (0, V.jsxs)(`head`, {
        children: [
          (0, V.jsx)(eu, {}),
          (0, V.jsx)(`style`, { dangerouslySetInnerHTML: { __html: ru } }),
        ],
      }),
      (0, V.jsxs)(`body`, { children: [e, (0, V.jsx)(tu, {})] }),
    ],
  });
}
function lu() {
  let { queryClient: e } = su.useRouteContext();
  return (0, V.jsx)(yc, { client: e, children: (0, V.jsx)(Vl, {}) });
}
var uu = `/assets/hero-kitchen-DIfcTxlP.webp`,
  du = `modulepreload`,
  fu = function (e) {
    return `/` + e;
  },
  ...
  mu = function (e, t, n) {
    ...
    if (t && t.length > 0) {
      ...
      r = o(
        t.map((t) => {
          if (((t = fu(t, n)), (t = s(t)), t in pu)) return;
          pu[t] = !0;
    ...
    IndexRoute: Al(`/`)({
      head: () => ({
        meta: [
          ...
          { property: `og:image`, content: uu },
          { name: `twitter:image`, content: uu },
        ],
      ...
      component: Ml(() => mu(() => import(`./routes-Ba8uO3bS.js`), []), `component`),
    }).update({ id: `/`, path: `/`, getParentRoute: () => su }),
  },
  gu = su._addFileChildren(hu),
  _u = () =>
    Ul({
      routeTree: gu,
...
function Su() {
  return (
    (xu ||= bu()),
    (0, V.jsx)(Ec, { promise: xu, children: (e) => (0, V.jsx)(Yl, { router: e }) })
  );
}
var Cu = y();
(0, B.startTransition)(() => {
  (0, Cu.hydrateRoot)(document, (0, V.jsx)(B.StrictMode, { children: (0, V.jsx)(Su, {}) }));
});
export { c as a, o as i, _c as n, d as o, p as r, u as s, uu as t };
