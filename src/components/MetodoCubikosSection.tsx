...
export default function MetodoCubikosSection() {
  ...
  return (
    <section
      id="metodo"
      className="relative bg-[#0E0E0D] text-[#FAF8F5] py-10 sm:py-14 lg:py-16 overflow-hidden border-t border-b border-white/10"
    >
      <div className="relative z-10 w-full max-w-[1380px] mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-14 items-start">
          ...
          {/* ════════ LEFT COLUMN (~42%): Editorial Header & Blueprint ════════ */}
          <div className="lg:col-span-5 flex flex-col justify-start">
            <div>
              ...
              <h2
                className="text-white font-normal leading-[1.06] tracking-tight mb-4 sm:mb-5"
                style={{
              ...
              {/* Compact Narrative */}
              <p className="text-[15px] sm:text-[16px] text-[#A6A29A] leading-[1.55] font-normal max-w-md mb-4 sm:mb-5">
                {d.intro}
              </p>

              {/* Mantra Phrase with Gold Dots */}
              <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1.5 text-[11px] sm:text-[12px] font-mono tracking-[0.14em] uppercase text-white/90 font-bold mb-5 sm:mb-6">
                {d.mantra.map((word, i) => (
            ...
            <div className="relative w-full max-w-[320px] p-2 rounded-[14px] bg-[#141413]/80 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300">
              <img
                src={faqBlueprint}
                alt="Plano técnico y alzado arquitectónico de cocina CUBIKOS"
                loading="lazy"
                className="w-full h-auto max-h-[140px] sm:max-h-[150px] object-contain transition-transform duration-500 hover:scale-[1.02] invert contrast-125 opacity-85"
              />
            </div>
          </div>

          {/* ════════ RIGHT COLUMN (~58%): The 4 Connected Precision Stages ════════ */}
              ...
              {d.stages.map((stage, index) => {
                ...
                return (
                  <div
                    ...
                    className="group cursor-pointer select-none py-3 sm:py-3.5 border-b border-white/10 last:border-b-0 transition-colors hover:bg-white/[0.02] rounded-lg px-2"
                  >
                        ...
                        <div className="relative flex flex-col items-center pt-1.5 sm:pt-2 w-4">
                          ...
                          <div
                            className={`w-2.5 h-2.5 rounded-full border-2 transition-all duration-300 z-10 ${
                              isActive
                                ? "border-[#D6A634] bg-[#D6A634] shadow-[0_0_10px_rgba(214,166,52,0.9)] scale-110"
                                : "border-[#D6A634]/50 bg-[#0E0E0D]"
                            }`}
                          />

                          {/* Line going down to next item */}
                          {!isLast && (
                            <div className="w-[1.5px] h-12 sm:h-14 bg-white/10 relative overflow-hidden mt-1">
                              <motion.div
                      ...
                      <div className="flex-1 min-w-0 pl-1 sm:pl-2">
                        ...
                        <span
                          className={`block text-[12px] sm:text-[13px] font-mono font-bold tracking-[0.24em] uppercase transition-colors duration-300 ${
                            isActive ? "text-[#D6A634]" : "text-[#8A857A]"
                          }`}
                        >
                          {stage.keyword}
                        </span>
                        ...
                        <h3
                          className={`text-[17px] sm:text-[19px] lg:text-[20px] font-bold tracking-tight leading-snug mt-1 transition-all duration-300 ${
                            isActive ? "text-white translate-x-0.5" : "text-[#E5E1D8]"
                          }`}
                        >
                          {stage.title}
                        </h3>
                        ...
                        {/* Short Description */}
                        <p className="mt-1.5 text-[13.5px] sm:text-[14.5px] text-[#A6A29A] font-normal leading-relaxed">
                          {stage.shortDesc}
                        </p>
                          ...
                          {isActive && (
                            ...
                            >
                              <div className="mt-4 pt-4 border-t border-white/10 space-y-3">
                                <p className="text-[14.5px] sm:text-[15.5px] text-[#C4BFB6] leading-[1.65] font-normal">
                                  {stage.longDesc}
                                </p>
                                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#181816] text-[12px] font-mono text-[#E5E1D8] border border-white/10">
                      ...
                      <div className="shrink-0 pt-2 pl-2">
                        <div
                          className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center border transition-all duration-300 ${
                            isActive
                              ? "bg-[#1C1C1A] border-[#D6A634] text-[#D6A634] shadow-sm rotate-45"
                              : "bg-transparent border-white/15 text-[#A6A29A] group-hover:border-[#D6A634] group-hover:text-[#D6A634]"
                          }`}
                        >
        ...
        {/* ════════ Bottom Closing Bar ════════ */}
        <div className="mt-8 sm:mt-10 py-5 px-6 sm:px-8 border border-white/10 rounded-[16px] bg-[#141413]/80 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 sm:gap-8">
            ...
            <div className="flex items-start gap-4 max-w-xl">
              ...
              <div>
                <p
                  className="text-white text-[16px] sm:text-[19px] font-normal leading-tight tracking-tight"
                  style={{ fontFamily: "var(--font-serif)" }}
                >
            ...
            <div className="flex items-center gap-4 lg:pl-8 lg:border-l border-white/10">
              <div className="w-10 h-10 rounded-[10px] bg-[#1A1A18] border border-[#D6A634]/40 flex items-center justify-center shrink-0 shadow-sm text-[#D6A634]">
                <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="flex flex-col">
                <span className="text-[14px] sm:text-[15px] font-bold text-white tracking-tight font-sans">
                  {d.badgeTitle}
                </span>
                <span className="text-[12.5px] sm:text-[13px] text-[#A6A29A] font-normal mt-0.5">
                  {d.badgeDesc}
                </span>
              </div>
            </div>
